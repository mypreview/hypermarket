...
add_action( 'woocommerce_before_main_content', 'hypermarket_before_loop_widget_region', 20 );
add_action( 'woocommerce_after_main_content', 'hypermarket_after_content' );
add_action( 'woocommerce_before_shop_loop', 'hypermarket_products_div', 0 );
add_action( 'woocommerce_after_shop_loop', 'woocommerce_pagination', 30 );
add_action( 'woocommerce_after_shop_loop', 'hypermarket_div_close', 30 );
